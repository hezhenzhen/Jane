<template>
  <div class="add-page">
    <Header headertitle="添加地址"></Header>
    <div class="container">
      <input type="text" placeholder="选择地区" readonly="" :value="addressText" @click="addressModel = true">
...
<script>
  ...
  import InitCityPicker from '../../../static/js/data.city.js'
  ...
  export default {
    ...
    mounted () {
      const that = this
      that.addressList = InitCityPicker
    },
    methods: {
